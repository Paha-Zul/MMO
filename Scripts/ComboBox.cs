...
public class ComboBox
{
    ...
    private static int useControlID = 0;
    ...
    public int Show()
    {
        ...
        if (isClickedComboButton)
        {
            Rect listRect = new Rect(rect.x, rect.y + rect.height, rect.width, rect.height);
    ...
    public GUIContent getCurrentSelectedContent()
    {
        return this.listContent[selectedItemIndex];
    }
}